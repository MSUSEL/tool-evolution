...
```{r}
all_together_now <- left_join(cve_bin_long_clusts, binaryAttrs) %>% 
  left_join(cwe_checker_version_clusters, by = "filename")
```

Step 3. Make some graphs
...
sankey(c("cve_cluster_3.1.1", "cve_cluster_2.0"))
```
